    ...
    return (
        ...
        >
            ...
            <div className="holiday-note">
                <p><strong>Let op:</strong> Scholen mogen afwijken van de adviesdata voor de voorjaars- en herfstvakantie. De meivakantie kan door scholen met een week worden uitgebreid. Controleer altijd de schoolgids.</p>
            </div>
        </motion.div>
    );
}
